...
function drawDrillDownChartBO($jsonObj, controlID, subControls, fldLabName, fldValue, strtYr, endYr, index, Min, Max, Units, seriescolors, chartTypeCode, currentChartObject) {
    ...
    // ===================================================
   // console.log("Drill Down Chart BO- ha!");
