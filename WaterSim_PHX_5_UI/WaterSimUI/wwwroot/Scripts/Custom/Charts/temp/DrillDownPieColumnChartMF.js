function drawDrillDownPieColumnChartMF($jsonObj, controlID, subcontrols, fldLabName, fldValue, providerName, index, Min, Max, Units) {
    ...
    console.log("Drill Down Pie Chart MF");
